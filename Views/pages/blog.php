            ...
            <div class="container px-5">
                        ...
                        <div class="card h-100 shadow border-0">
                            ...
                            <div class="card-body p-4">
                                ...
                                <a class="text-decoration-none link-dark stretched-link" href="blog-p_2.php">
                                    <div class="h5 card-title mb-3">Technologie chytrých měst</div>
                                </a> <!-- Druhy članek-->
                        ...
                        <div class="card h-100 shadow border-0">
                            ...
                            <div class="card-body p-4">
                                ...
                                <a class="text-decoration-none link-dark stretched-link" href="blog-p_3.php">
                                    <div class="h5 card-title mb-3">Životní prostředí</div>
                                </a>
                    ...
                    <div class="col-lg-4 mb-5">
                        <div class="card h-100 shadow border-0">
                            ...
                            <div class="card-body p-4">
                                ...
                                <a class="text-decoration-none link-dark stretched-link" href="blog-p_4.php">
                                    <div class="h5 card-title mb-3">Projekty chytrých měst po celém světě</div>
                                </a>
                ...
                <div class="col-lg-4 mb-5"> <!-- Přidání nových článků-->
                    <div class="card h-100 shadow border-0">
                        ...
                        <div class="card-body p-4">
                            <div class="badge bg-primary bg-gradient rounded-pill mb-2">Novinka</div>
                            <a class="text-decoration-none link-dark stretched-link" href="blog-p_5.php">
                                <div class="h5 card-title mb-3">The Line </div>
                            </a>
                ...
                <?php if (isset($_SESSION['user_id'])): ?>
                    <div class="container px-5 mb-4">
                        <a href="../post/create_user_post.php" class="btn btn-primary">Přidat vlastní článek na fórum</a>
                    </div>
                <?php endif; ?>
            </div>
